...
module.exports = {
  ...
  SSLCOMMERZ_SUCCESS_URL: process.env.SSLCOMMERZ_SUCCESS_URL || 'https://rest.ourb.live/api/payments/sslcommerz/success',
  SSLCOMMERZ_FAIL_URL: process.env.SSLCOMMERZ_FAIL_URL || 'https://rest.ourb.live/api/payments/sslcommerz/fail',
  SSLCOMMERZ_CANCEL_URL: process.env.SSLCOMMERZ_CANCEL_URL || 'https://rest.ourb.live/api/payments/sslcommerz/cancel',
  SSLCOMMERZ_IPN_URL: process.env.SSLCOMMERZ_IPN_URL || 'https://rest.ourb.live/api/payments/sslcommerz/ipn'
}; 